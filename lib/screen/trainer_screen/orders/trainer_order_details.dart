...
import 'package:morrf/screen/trainer_screen/orders/trainer_deliver_order.dart';
import 'package:morrf/widgets/button_global.dart';
import 'package:nb_utils/nb_utils.dart';
import 'package:slide_countdown/slide_countdown.dart';

import '../../../widgets/constant.dart';
import '../trainer_popUp/trainer_popup.dart';

class TrainerOrderDetails extends StatefulWidget {
  const TrainerOrderDetails({super.key});

  @override
  State<TrainerOrderDetails> createState() => _TrainerOrderDetailsState();
}

class _TrainerOrderDetailsState extends State<TrainerOrderDetails> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: isSelected == 'Completed'
          ? ButtonGlobalWithoutIcon(
              ...
              onPressed: () {
                setState(() {
                  const TrainerDeliverOrder().launch(context);
                });
              },
                  ...
                  Expanded(
                    child: ButtonGlobalWithoutIcon(
                      ...
                      buttonDecoration: kButtonDecoration.copyWith(
                          color: kWhite, border: Border.all(color: Colors.red)),
                      onPressed: () {
                        setState(() {
                          cancelOrderPopUp();
                        });
