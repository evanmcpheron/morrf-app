...
class TrainerInvite extends StatefulWidget {
  const TrainerInvite({super.key});

  @override
  State<TrainerInvite> createState() => _TrainerInviteState();
}

class _TrainerInviteState extends State<TrainerInvite> {
