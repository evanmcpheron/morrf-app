...
import 'package:morrf/screen/trainer_screen/profile/trainer_edit_profile_details.dart';
...
class TrainerProfileDetails extends StatefulWidget {
  const TrainerProfileDetails({super.key});

  @override
  State<TrainerProfileDetails> createState() => _TrainerProfileDetailsState();
}
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () => const TrainerEditProfile().launch(context),
                      child: Text(
                        'Edit',
