...
class TrainerWithdrawMoney extends StatefulWidget {
  const TrainerWithdrawMoney({super.key});

  @override
  State<TrainerWithdrawMoney> createState() => _TrainerWithdrawMoneyState();
}

class _TrainerWithdrawMoneyState extends State<TrainerWithdrawMoney> {
