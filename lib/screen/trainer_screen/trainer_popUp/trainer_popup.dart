...
class TrainerAddLanguagePopUp extends StatefulWidget {
  ...
  @override
  State<TrainerAddLanguagePopUp> createState() =>
      _TrainerAddLanguagePopUpState();
}

class _TrainerAddLanguagePopUpState extends State<TrainerAddLanguagePopUp> {
...
class TrainerAddSkillPopUp extends StatefulWidget {
  const TrainerAddSkillPopUp({super.key});

  @override
  State<TrainerAddSkillPopUp> createState() => _TrainerAddSkillPopUpState();
}

class _TrainerAddSkillPopUpState extends State<TrainerAddSkillPopUp> {
  //__________language level___________________________________________________
  DropdownButton<String> getLevel() {
    List<DropdownMenuItem<String>> dropDownItems = [];
              ...
              children: [
                ...
                Expanded(
                  child: Button(
                    ...
                    onPressed: () {
                      finish(context);
                      const TrainerProfile().launch(context);
                    },
                  ),
                ),
              ],
