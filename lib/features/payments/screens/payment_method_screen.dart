...
class _PaymentMethodsScreenState extends ConsumerState<PaymentMethodsScreen> {
  ...
  Future<void> updateDefault(String cardId) async {
    setState(() {
      isLoading = true;
    });
    await ref.read(morrfCrediCardProvider.notifier).updateDefaultCard(cardId);
    setState(() {
      isLoading = false;
    });
  }
          ...
          : Column(
              children: [
                ...
                const Padding(
                  ...
                  child: MorrfText(
                      text: "Tap a card to change default.", size: FontSize.p),
                ),
                const Padding(
                  padding: EdgeInsets.only(bottom: 8.0),
                  child: MorrfText(text: "Swipe to delete.", size: FontSize.p),
                ),
                SafeArea(
                  child: MorrfButton(
                      onPressed: () =>
